  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :model="queryParams" size="small" :inline="true" label-width="68px">
      ...
      <!-- <el-form-item label="商户地址" prop="avatar">
        <el-input v-model="queryParams.avatar" placeholder="请输入商户地址" clearable @keyup.enter.native="handleQuery" />
      </el-form-item> -->
      <el-form-item>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <!-- <el-form-item label="商户类型" prop="type">
          <el-select v-model="form.type" placeholder="请选择">
            <el-option v-for="item in dict.type.merchant_type" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item> -->
        <el-form-item label="联系方式" prop="contact">
