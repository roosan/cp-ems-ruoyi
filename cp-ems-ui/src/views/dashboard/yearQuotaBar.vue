...
export default {
  ...
  props: {
    ...
    yData: {
      ...
      default: () => {
        return {
          quotaData: [79, 52, 200, 334, 390, 330, 220, 0, 21, 67, 234, 21],
          energyData: [23, 432, 123, 34, 9, 23, 220, 34, 21, 67, 234, 12]
        }
      }
    }
  },
