      ...
      <div style="height:calc(100% - 72px);padding: 0px 20px;overflow:auto;">
        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="110px">
          ...
          <div style="font-size:14px;">
            <el-form-item label="计划名称" prop="planName">
              <el-input v-model="form.planName" placeholder="暂无内容" disabled />
            </el-form-item>
            <el-form-item label="项目名称" prop="projectName">
              <el-input v-model="form.projectName" placeholder="暂无内容" disabled />
            </el-form-item>
            <el-form-item label="巡检内容" prop="planContent">
              <el-input v-model="form.planContent" type="textarea" rows="3" placeholder="暂无内容" disabled />
            </el-form-item>
          ...
          <div style="font-size:14px;">
            <el-form-item label="巡检人">
              <el-select v-model="form.userIds" multiple placeholder="暂无内容" disabled style="width:100%;" @change="personChange">
                <el-option
            ...
            <el-form-item label="巡检记录">
              <el-input v-model="form.inspectionRemark" type="textarea" rows="3" placeholder="暂无内容" :disabled="disabled" />
            </el-form-item>
          </div>
        </el-form>
      </div>
